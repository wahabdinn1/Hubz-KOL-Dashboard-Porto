...
import { Instagram, Music2 } from "lucide-react"; // Music2 for TikTok usually
...
export function KOLProfileDialog({ kol, children }: KOLProfileDialogProps) {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px] p-0 gap-0 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white dark:bg-zinc-950 sm:rounded-xl overflow-hidden">
                <div className="p-4 border-b-2 border-black bg-white dark:bg-zinc-900">
